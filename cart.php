                                ...
                                <?php foreach ($_SESSION['cart'] as $item): ?>
                                    <tr class="border-b border-gray-200 hover:bg-gray-100" data-id="1">
                                        <td class="py-3 px-6 text-left flex items-center">
                                            <img class="w-10 h-10 rounded-full mr-2" src="<?php echo $item['image']; ?>" alt="Organic Lemon">
                                            <span><?php echo $item['name']; ?></span>
                                        </td>
                                        <td class="py-3 px-6 text-center"><?php echo $item['price']; ?></td>
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex justify-center items-center">
                                                <button class="px-2 py-1 border" onclick="changeQuantity(this, -1)">-</button>
                                                <input class="mx-2 w-10 text-center border" type="text" value="<?php echo $item['quantity']; ?>" readonly>
                                                <button class="px-2 py-1 border" onclick="changeQuantity(this, 1)">+</button>
                                            </div>
                                        </td>
                                        <td class="py-3 px-6 text-center"><span class="item-total"><?php echo $item['price']; ?></span></td>
                                        <td class="py-3 px-6 text-center">
