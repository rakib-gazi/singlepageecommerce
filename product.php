            ...
            <div>
                ...
                <div class="flex items-center relative">
                    <div class="relative w-3/4">
                        ...
                        <div id="hs-large-modal-<?php echo $index; ?>" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-large-modal-label-<?php echo $index; ?>">
                                ...
                                <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto ">
                                    ...
                                    <div class="p-4 overflow-y-auto grid grid-cols-2">
                                        ...
                                        <div class="flex relative">
                                            <div class="w-3/4">
                                                <img src="<?php echo $product['image']; ?>" alt="Product Image" class="rounded-lg shadow-lg w-full">
                                            </div>
                                            <!-- Thumbnail Images -->
                                        ...
                                        <div>
                                            ...
                                            <div class="flex space-x-4 mt-6">
                                                ...
                                                <button class="px-6 py-3 bg-white border border-gray-300 rounded-lg shadow hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500" type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-large-modal-<?php echo $index; ?>" data-hs-overlay="#hs-large-modal-<?php echo $index; ?>">View</button>
                                            </div>
                                        </div>
                                    </div>
